...
### TODO TODO TODO rewrite for new IB+Carette pipeline!
### The plan is to completely replace mutant_count_alignments.py with this, and mutant_analysis_classes.py and mutant_Carette.py with mutant_IB_analysis.py.
