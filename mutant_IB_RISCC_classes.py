...
import HTSeq
# from BCBio import GFF - instead of importing this toplevel I'm only importing it in the functions that need it, because sometimes I can't get BCBio on the server and I'd like to still be able to use some other elements from this.
# my modules
...
class Insertional_mutant_pool_dataset():
    ...
    def _find_genes_for_list(self, insertion_data_by_chromosome, genome_version, genefile, detailed_features=False, 
                             nearest_genes_for_intergenic=False, N_run_groups=3, verbosity_level=1):
        from BCBio import GFF # importing here instead of toplevel because sometimes it's missing
