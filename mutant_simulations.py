...
def gene_mappability(mappability_by_flanking_region, exclude_UTRs=False, genefile=mutant_utilities.DEFAULT_GENE_POS_FILE, 
    ...
    If exclude_UTRs is True, the mappable lengths are calculated excluding UTRs; for genes with multiple splice variants, it.
        calculates it based the start of the first exon and the end of the last one.
    If exclude_UTRs is "5'UTR", same but only for the last exon (so include 5'UTR and exclude 3')
