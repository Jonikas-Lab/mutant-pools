...
def simulate_dataset_from_mappability(N_mutants, fraction_20bp, mappable_positions_20bp, mappable_positions_21bp, 
    ...
    # MAYBE-TODO implement simplified version that totally ignores strand, in the mappability inputs as well as the outputs, to make things faster?  Except that it won't really - I don't think the no-strand data is any smaller than the with-strand. 
